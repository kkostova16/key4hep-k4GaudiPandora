...
using retType = std::tuple<std::map<std::string, edm4hep::CalorimeterHitCollection>,
                           edm4hep::MCRecoCaloAssociationCollection>;  //FIXME: Does this need to be a map as well???

struct DDCaloDigi final : k4FWCore ::MultiTransformer << retType >
    (const std::map<std::string, const edm4hep::SimCalorimeterHitCollection&>, const edm4hep::EventHeaderCollection&) >
{
...
private:
  ...
  Gaudi::Property<std::string> _unitThresholdEcal{
      this,
      "ECALThresholdUnit",
      {"GeV"},
      "Unit for ECAL Threshold. Can be \"GeV\", \"MIP\" or \"px\". MIP and px need properly set calibration constants"};
  Gaudi::Property<float> _thresholdHcal{
      this,
      "HCALThreshold",
      {0.00004},
      "Unit for ECAL Threshold. Can be \"GeV\", \"MIP\" or \"px\". MIP and px need properly set calibration constants"};
  Gaudi::Property<std::string> _unitThresholdHcal{
      this,
      "HCALThresholdUnit",
      {"GeV"},
  ...
  Gaudi::Property<std::vector<float>> _calibrCoeffEcal{
      this, "CalibrECAL", {calibrEcal}, "Calibration coefficients for ECAL"};
  std::vector<float> calibrHcalBarrel;
  calibrHcalBarrel.push_back(0.);
  Gaudi::Property<std::vector<float>> _calibrCoeffHcalBarrel{
      this, "CalibrHCALBarrel", {calibrHcalBarrel}, "Calibration coefficients for Barrel HCAL"};
  std::vector<float> calibrHcalEndCap;
  calibrHcalEndCap.push_back(0.);
  Gaudi::Property<std::vector<float>> _calibrCoeffHcalEndCap{
      this, "CalibrHCALEndCap", {calibrHcalEndCap}, "Calibration coefficients for EndCap HCAL"};
  std::vector<float> calibrHcalOther;
  calibrHcalOther.push_back(0.);
  Gaudi::Property<std::vector<float>> _calibrCoeffHcalOther{
      this, "CalibrHCALOther", {calibrHcalOther}, "Calibration coefficients for Other HCAL"};
  Gaudi::Property<int> _digitalEcal{this, "IfDigitalEcal", {0}, "Digital Ecal"};
  Gaudi::Property<int> _mapsEcalCorrection{
  ...
  Gaudi::Property<int> _ecalGapCorrection{
      this, "ECAconst float slop = 0.25; // (mm)LGapCorrection", {1}, "Correct for ECAL gaps"};
  Gaudi::Property<int>   _hcalGapCorrection{this, "HCALGapCorrection", {1}, "Correct for HCAL gaps"};
  Gaudi::Property<float> _ecalEndcapCorrectionFactor{
      this, "ECALEndcapCorrectionFactor", {1.025}, "Energy correction for ECAL endcap"};
  Gaudi::Property<float> _hcalEndcapCorrectionFactor{
      this, "HCALEndcapCorrectionFactor", {1.025}, "Energy correction for HCAL endcap"};
  Gaudi::Property<float> _ecalGapCorrectionFactor{
      this, "ECALGapCorrectionFactor", {1.0}, "Factor applied to gap correction"};
  Gaudi::Property<float> _ecalModuleGapCorrectionFactor{
      this, "ECALModuleGapCorrectionFactor", {0.5}, "Factor applied to module gap correction ECAL"};
  Gaudi::Property<float> _hcalModuleGapCorrectionFactor{
  ...
  Gaudi::Property<int> _ecalCorrectTimesForPropagation{
  ...
  Gaudi::Property<float> _ecalEndcapTimeWindowMax{
      this, "ECALEndcapTimeWindowMax", {100}, "ECAL Endcap Time Window maximum time in ns"};
  Gaudi::Property<float> _ecalBarrelTimeWindowMax{
      this, "ECALBarrelTimeWindowMax", {100}, "ECAL Barrel Time Window maximum time in ns"};
  Gaudi::Property<float> _ecalDeltaTimeHitResolution{
      this, "ECALDeltaTimeHitResolution", {10}, "ECAL Minimum Delta Time in ns for resolving two hits"};
  Gaudi::Property<float> _ecalTimeResolution{
      this, "ECALTimeResolution", {10}, "ECAL Time Resolution used to smear hit times"};
  Gaudi::Property<bool> _ecalSimpleTimingCut{
      this,
      "ECALSimpleTimingCut",
      {true},
  ...
  Gaudi::Property<int> _hcalCorrectTimesForPropagation{
  ...
  Gaudi::Property<float> _hcalEndcapTimeWindowMax{
      this, "HCALEndcapTimeWindowMax", {100}, "HCAL Endcap Time Window maximum time in ns"};
  Gaudi::Property<float> _hcalBarrelTimeWindowMax{
      this, "HCALBarrelTimeWindowMax", {100}, "HCAL Barrel Time Window maximum time in ns"};
  Gaudi::Property<float> _hcalDeltaTimeHitResolution{
      this, "HCALDeltaTimeHitResolution", {10}, "HCAL Minimum Delta Time in ns for resolving two hits"};
  Gaudi::Property<float> _hcalTimeResolution{
      this, "HCALTimeResolution", {10}, "HCAL Time Resolution used to smear hit times"};
  Gaudi::Property<bool> _hcalSimpleTimingCut{
      this,
      "HCALSimpleTimingCut",
      {true},
      "Use simple time window cut on hit times? If false: use original hit-time clustering algorithm. If true: use "
      "time window defined by HCALBarrelTimeWindowMin and HCALBarrelTimeWindowMax"};
  Gaudi::Property<float> _calibEcalMip{
      this, "CalibECALMIP", {1.0e-4}, "calibration to convert ECAL deposited energy to MIPs"};
  Gaudi::Property<int>   _applyEcalDigi{this,
                                      "ECAL_apply_realistic_digi",
                                        {0},
                                      "apply realistic digitisation to ECAL hits? (0=none, 1=silicon, 2=scintillator)"};
  Gaudi::Property<float> _ecal_PPD_pe_per_mip{
      this, "ECAL_PPD_PE_per_MIP", {7.0}, "# Photo-electrons per MIP (scintillator): used to poisson smear #PEs if >0"};
  Gaudi::Property<int> _ecal_PPD_n_pixels{
      this,
      "ECAL_PPD_N_Pixels",
      {10000},
      "ECAL total number of MPPC/SiPM pixels for implementation of saturation effect"};
  Gaudi::Property<float> _ecal_misCalibNpix{
      this,
      "ECAL_PPD_N_Pixels_uncertainty",
      {0.05},
      "ECAL fractional uncertainty of effective total number of MPPC/SiPM pixels"};
  Gaudi::Property<float> _misCalibEcal_uncorrel{
      this,
      "ECAL_miscalibration_uncorrel",
      {0.0},
      "uncorrelated ECAL random gaussian miscalibration (as a fraction: 1.0 = 100%"};
  Gaudi::Property<bool> _misCalibEcal_uncorrel_keep{
      this,
  ...
  Gaudi::Property<float> _misCalibEcal_correl{
      this,
      "ECAL_miscalibration_correl",
      {0.0},
      "correlated ECAL random gaussian miscalibration (as a fraction: 1.0 = 100%"};
  Gaudi::Property<float> _deadCellFractionEcal{
      this, "ECAL_deadCellRate", {0.0}, "ECAL random dead cell fraction (as a fraction: 0->1)"};
  Gaudi::Property<bool> _deadCellEcal_keep{
      this,
      "ECAL_deadCell_memorise",
      {false},
      "store dead ECAL cells in memory? (WARNING: can take a lot of memory if used..."};
  Gaudi::Property<float> _strip_abs_length{
      this, "ECAL_strip_absorbtionLength", {1000000.0}, "length scale for absorbtion along scintillator strip (mm)"};
  Gaudi::Property<float> _ecal_pixSpread{
      this, "ECAL_pixel_spread", {0.05}, "variation of mppc/sipm pixels capacitance in ECAL (as a fraction: 0.01=1%)"};
  Gaudi::Property<float> _ecal_elec_noise{
      this, "ECAL_elec_noise_mips", {0.}, "typical electronics noise (ECAL, in MIP units)"};
  Gaudi::Property<float> _ehEnergy{
      this, "energyPerEHpair", {3.6}, "energy required to create e-h pair in silicon (in eV)"};
  Gaudi::Property<float> _ecalMaxDynMip{
      this, "ECAL_maxDynamicRange_MIP", {2500.}, "maximum of dynamic range for ECAL (in MIPs)"};
  Gaudi::Property<int> _ecalStrip_default_nVirt{
      this, "StripEcal_default_nVirtualCells", {9}, "default number of virtual cells (used if not found in gear file)"};
  Gaudi::Property<std::string> _ecal_deafult_layer_config{
      this,
      "ECAL_default_layerConfig",
      {"000000000000000"},
      "default ECAL layer configuration (used if not found in gear file"};
  Gaudi::Property<float> _calibHcalMip{
      this, "CalibHCALMIP", {1.0e-4}, "calibration to convert HCAL deposited energy to MIPs"};
  Gaudi::Property<int>   _applyHcalDigi{this,
                                      "HCAL_apply_realistic_digi",
                                        {0},
                                      "apply realistic digitisation to HCAL hits? (0=none, 1=silicon, 2=scintillator)"};
  Gaudi::Property<float> _hcal_PPD_pe_per_mip{
      this, "HCAL_PPD_PE_per_MIP", {7.0}, "# Photo-electrons per MIP (scintillator): used to poisson smear #PEs if >0"};
  Gaudi::Property<int> _hcal_PPD_n_pixels{
      this,
      "HCAL_PPD_N_Pixels",
      {10000},
      "HCAL total number of MPPC/SiPM pixels for implementation of saturation effect"};
  Gaudi::Property<float> _hcal_misCalibNpix{
      this,
      "HCAL_PPD_N_Pixels_uncertainty",
      {0.05},
      "HCAL fractional uncertainty of effective total number of MPPC/SiPM pixels"};
  Gaudi::Property<float> _misCalibHcal_uncorrel{
      this,
      "HCAL_miscalibration_uncorrel",
      {0.0},
      "uncorrelated HCAL random gaussian miscalibration (as a fraction: 1.0 = 100%"};
  Gaudi::Property<bool> _misCalibHcal_uncorrel_keep{
      this,
  ...
  Gaudi::Property<float> _misCalibHcal_correl{
      this,
      "HCAL_miscalibration_correl",
      {0.0},
      "correlated HCAL random gaussian miscalibration (as a fraction: 1.0 = 100%"};
  Gaudi::Property<float> _deadCellFractionHcal{
      this, "HCAL_deadCellRate", {0.0}, "HCAL random dead cell fraction (as a fraction: 0->1)"};
  Gaudi::Property<bool> _deadCellHcal_keep{
      this,
      "HCAL_deadCell_memorise",
      {false},
      "store dead HCAL cells in memory? (WARNING: can take a lot of memory if used..."};
  Gaudi::Property<float> _hcal_pixSpread{
      this, "HCAL_pixel_spread", {0.05}, "variation of mppc/sipm pixels capacitance in HCAL (as a fraction: 0.01=1%)"};
  Gaudi::Property<float> _hcal_elec_noise{
      this, "HCAL_elec_noise_mips", {0.}, "typical electronics noise (ECAL, in MIP units)"};
  Gaudi::Property<float> _hcalMaxDynMip{
      this, "HCAL_maxDynamicRange_MIP", {2500.}, "maximum of dynamic range for HCAL (in MIPs)"};
