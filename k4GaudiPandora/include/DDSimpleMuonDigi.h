...
private:
  ...
  Gaudi::Property<std::vector<int>> layersToKeepBarrelVec{
    this, "KeepBarrelLayersVec", {0}, "Vector of Barrel layers to be kept. Layers start at 1!"};
  Gaudi::Property<std::vector<int>> layersToKeepEndCapVec{
  ...
  Gaudi::Property<std::vector<std::string>> muonCollections{this, "muon_collections", {"muon_collections"}, "Collection of Muons"};
  ...
  Gaudi::Property<std::string> _cellIDLayerString {this, "CellIDLayerString","Layer", "Name of the part of the cellID that holds the layer"};                                           
  Gaudi::Property<float> thresholdMuon{this, "MuonThreshold", {0.025}, "Threshold for muon"};
  Gaudi::Property<float> m_timeThresholdMuon{this, "timethresholdMuon", {0.025}, "time threshold for muons"};
  Gaudi::Property<float> calibrCoeffMuon{this, "calibrationCoeffmuon", {120000.0}, "Callibration coefficient of muons"};
  Gaudi::Property<float> maxHitEnergyMuon{this, "maxMuonHitEnergy", {2.0}, "Threshold for maximum muon hit energy"};
